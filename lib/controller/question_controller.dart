...
class QuestionController extends BaseRefreshController {
  ...
  void getQuestion({bool refresh = false}) {
    Future future = Http.instance.get(Api.question(refresh ? 0 : ++_page));
