...
class RecommendController extends BaseRefreshController {
  ...
  void getRecommend({bool refresh = false}) {
    Future future = Http.instance.get(Api.recommend(refresh ? 0 : ++_page));
    ...
    handleRequest(future, (value) {
      ...
      print("getRecommend error: $error");
      // 网络请求出错
      if (refresh) {
        refreshController.refreshFailed();
      } else {
